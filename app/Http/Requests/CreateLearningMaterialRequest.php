...
class CreateLearningMaterialRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'file' => 'required_if:material_type,notes,video,slides,handout,podcast,ebook|file|mimes:mp4,mkv,mov,avi,wmv,pdf,doc,docx,ppt,pptx,txt,zip,png,jpeg,jpg|max:102400',
